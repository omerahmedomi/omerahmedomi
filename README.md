# Hey there 👋 I'm Umer Ahmed

**Full Stack Developer** | Building scalable web applications with modern technology  
📍 Addis Ababa, Ethiopia | 💻 Open to collaboration & opportunities

---

## About Me

I'm a Computer Science graduate from Addis Ababa University with a passion for building full-stack web applications. I specialize in crafting seamless user experiences on the frontend while architecting robust backends that power real-world solutions. I'm committed to writing clean, maintainable code and continuously learning emerging technologies.
...
🔗 [Repository](https://github.com/omerahmedomi/Todo-Manager) | Tech: PostgreSQL, Express, React, Node.js

### **Subscription Tracker API** - Backend Service
A real-world subscription tracking API that monitors service renewals and sends timely email reminders.  
🔗 [Repository](https://github.com/omerahmedomi/Subscription-Tracking-API) | Tech: Node.js, Express, Email Integration
